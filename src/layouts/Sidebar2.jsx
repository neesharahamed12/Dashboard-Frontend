...
const Sidebar = ({ isExpanded }) => {
    ...
    useEffect(() => {
        if (location.pathname === '/about-us' || location.pathname === '/contact-us') {
            ...
            setIsPage(false); // Collapse dropdown if user navigates elsewhere
        }
        if (location.pathname === '/') {
            setIsDrop(true); // Keep dropdown open
        } else {
            setIsDrop(false); // Collapse dropdown if user navigates elsewhere
        }
    }, [location.pathname]);
                        ...
                        <div className="text-slate-300 m-4 ">
                            ...
                            <div className="">
                                ...
                                <div className=''>
                                    ...
                                    <div className={`ms-5 transition-all duration-300 ease-in-out ${isDrop ? '' : 'hidden'}`}>
                                        <ul >
                                ...
                                <div className=''>
                                    {/* Heading - Pages */}
                                    <div className="ml-1 " >
                                        <button className="w-full p-2 h-10 hover:bg-[#021c50] hover:text-white rounded-md " onClick={() => setIsPage(!isPage)}>
                                            <div className="flex items-center  justify-between">
                                                <div className="col-span-3 felx items-center">
                                                    <FaHome className="inline-block " />
                                    ...
                                    {/* Dropdown List - Pages */}
                                    <div className={`ms-5 transition-all duration-300 ease-in-out ${isPage ? '' : 'hidden'}`}>
                                        <ul >
                                            ...
                                            <li className="">
                                                <button className="hover:bg-[#021c50] hover:text-white px-2 py-1.5 rounded-md w-full" onClick={() => { setIsBlog(!isBlog) }}>
                                                ...
                                                <div className={`ms-5 transition-all duration-300 ease-in-out ${isBlog ? '' : 'hidden'}`}>
                                                    <ul >
